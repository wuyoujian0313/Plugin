...
$.widget( "sustainablepace.mobipick", $.mobile.widget, {
	...
	_confirmDate: function() {
		var proceed    = true,
		    ...
		    dateDiff   = this._getDate().diffDays( this.element[0].value ),
	...
	// View
	//
	_markup: "<div class='mobipick-main'><div class='mobipick-date-formatted'>Date</div>" +
        "<ul class='mobipick-groups'>" +
        "<li><ul><li><a class='mobipick-next-year'>+</a></li><li><input type='text' class='mobipick-input mobipick-year' /></li><li><a class='mobipick-prev-year'>-</a></li></ul></li>" +
        "<li><ul><li><a class='mobipick-next-month'>+</a></li><li><input type='text' class='mobipick-input mobipick-month' /></li><li><a class='mobipick-prev-month'>-</a></li></ul></li>" +
        "<li><ul><li><a class='mobipick-next-day'>+</a></li><li><input type='text' class='mobipick-input mobipick-day' /></li><li><a class='mobipick-prev-day'>-</a></li></ul></li>" +
        "</ul>" +
        "<ul class='mobipick-buttons'><li><a class='mobipick-set'>确定</a></li><li><a class='mobipick-cancel'>取消</a></li></ul>" +
        "</div>",
	...
	_updateView: function() {
		...
		p.find( ".mobipick-set"    ).text( locale.ok     || "确定"    );
		p.find( ".mobipick-cancel" ).text( locale.cancel || "取消" );
